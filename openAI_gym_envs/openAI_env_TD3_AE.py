...
class RLAgent:
    def __init__(self, env):
        ...
        # main networks
        self.actor  = Actor(self.latent_dim, self.action_dim, self.max_action_value).to(device)
        self.critic = Critic(self.latent_dim, self.action_dim).to(device)
        # target networks
        self.actor_target  = Actor(self.latent_dim, self.action_dim, self.max_action_value).to(device)
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def run_training_rl_method(env, agent, max_action_value, env_name, frames_stack, num_episodes_training=500, episode_horizont=200):
    total_reward = []
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def autoencoder_evaluation(agent, frames_stack, env_name):
    state_image        = frames_stack.reset()
...
def main():
    ...
    run_random_exploration(env, agent, frames_stack, episode_horizont=episode_horizont)
    #run_training_rl_method(env, agent, max_action_value, env_name, frames_stack, episode_horizont=episode_horizont)
    #autoencoder_evaluation(agent, frames_stack, env_name)
    env.close()
