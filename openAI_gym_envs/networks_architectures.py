...
class Critic(nn.Module):
    def __init__(self, vector_size, num_actions):
        ...
        self.Q1 = nn.Sequential(
            ...
            #nn.Linear(self.hidden_size[2], self.num_actions)  # my way the output is the size on action space
        )
...
class Actor(nn.Module):
    def __init__(self, vector_size, num_actions, max_value):
    ...
    def forward(self, state):
        ...
        x = torch.tanh(self.h_linear_4(x)) * self.max_value
        return x
